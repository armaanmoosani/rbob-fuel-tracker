...
def get_market_data():
    try:
        ...
        ticker = yf.Ticker("RB=F", session=session)
    except ImportError:
...
<body style="margin:0;padding:0;background-color:#f1f5f9;
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f1f5f9;">
    ...
    <div style="background:#f8fafc;border-left:1px solid #e2e8f0;
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td width="25%" style="padding:6px 10px 10px;border-right:1px solid #e2e8f0;text-align:center;">
            <p style="margin:0;font-size:8px;color:#64748b;text-transform:uppercase;letter-spacing:0.07em;">Open</p>
            <p style="margin:4px 0 0;font-size:14px;font-weight:600;color:#334155;">${open_price:.4f}</p>
          </td>
          <td width="25%" style="padding:6px 10px 10px;border-right:1px solid #e2e8f0;text-align:center;">
            <p style="margin:0;font-size:8px;color:#64748b;text-transform:uppercase;letter-spacing:0.07em;">Day High</p>
            <p style="margin:4px 0 0;font-size:14px;font-weight:600;color:#22c55e;">{f"${high_price:.4f}" if high_price > 0 else "N/A"}</p>
          </td>
          <td width="25%" style="padding:6px 10px 10px;border-right:1px solid #e2e8f0;text-align:center;">
            <p style="margin:0;font-size:8px;color:#64748b;text-transform:uppercase;letter-spacing:0.07em;">Day Low</p>
          ...
          <td width="25%" style="padding:6px 10px 10px;text-align:center;">
            <p style="margin:0;font-size:8px;color:#64748b;text-transform:uppercase;letter-spacing:0.07em;">$ Change</p>
    ...
    <div style="background:#ffffff;border-left:1px solid #e2e8f0;
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td width="25%" style="padding:6px 10px 10px;border-right:1px solid #e2e8f0;text-align:center;">
            <p style="margin:0;font-size:8px;color:#64748b;text-transform:uppercase;letter-spacing:0.07em;">Yest. Close</p>
            <p style="margin:4px 0 0;font-size:14px;font-weight:600;color:#334155;">{yest_cell}{yest_chg}</p>
          </td>
          <td width="25%" style="padding:6px 10px 10px;border-right:1px solid #e2e8f0;text-align:center;">
            <p style="margin:0;font-size:8px;color:#64748b;text-transform:uppercase;letter-spacing:0.07em;">5-Day High</p>
            <p style="margin:4px 0 0;font-size:14px;font-weight:600;color:#334155;">{fmt(five_day_high)}</p>
          </td>
          <td width="25%" style="padding:6px 10px 10px;border-right:1px solid #e2e8f0;text-align:center;">
            <p style="margin:0;font-size:8px;color:#64748b;text-transform:uppercase;letter-spacing:0.07em;">5-Day Low</p>
            <p style="margin:4px 0 0;font-size:14px;font-weight:600;color:#334155;">{fmt(five_day_low)}</p>
          </td>
          <td width="25%" style="padding:6px 10px 10px;text-align:center;">
            <p style="margin:0;font-size:8px;color:#64748b;text-transform:uppercase;letter-spacing:0.07em;">30-Day Avg</p>
            <p style="margin:4px 0 0;font-size:14px;font-weight:600;color:#334155;">{fmt(thirty_day_avg)}{ctx_30d_vs}</p>
          </td>
        </tr>
      </table>
    </div>
    ...
    <div style="background:#f8fafc;padding:12px 20px 16px;
      ...
      <div style="position:relative;height:4px;background:#e2e8f0;border-radius:2px;">
        <div style="height:4px;width:{range_bar_pos:.0f}%;
                    background:linear-gradient(to right,#cbd5e1,#94a3b8);border-radius:2px;"></div>
    ...
    <div style="background:#f1f5f9;border-radius:0 0 10px 10px;padding:10px 20px;
      ...
      <p style="margin:0;font-size:9px;color:#64748b;line-height:1.6;">
        ...
        <a href="https://github.com/armaanmoosani/rbob-fuel-tracker"
           style="color:#2563eb;text-decoration:none;">armaanmoosani/rbob-fuel-tracker</a>
